...
VIB_TO_WIND_SENSOR_MAP = {
    # 跨中振动传感器 -> 跨中风传感器
    # 列表内的风传感器分别为跨中上游风速传感器和下游风速传感器
    'ST-VIC-C18-102-01': ['ST-UAN-G04-001-01', 'ST-UAN-G04-002-01'],
    'ST-VIC-C18-101-01': ['ST-UAN-G04-001-01', 'ST-UAN-G04-002-01'],
    'ST-VIC-C18-201-01': ['ST-UAN-G04-001-01', 'ST-UAN-G04-002-01'],
    'ST-VIC-C18-202-01': ['ST-UAN-G04-001-01', 'ST-UAN-G04-002-01'],
    'ST-VIC-C34-101-01': ['ST-UAN-G04-001-01', 'ST-UAN-G04-002-01'],
    'ST-VIC-C34-102-01': ['ST-UAN-G04-001-01', 'ST-UAN-G04-002-01'],
    'ST-VIC-C34-201-01': ['ST-UAN-G04-001-01', 'ST-UAN-G04-002-01'],
    'ST-VIC-C34-202-01': ['ST-UAN-G04-001-01', 'ST-UAN-G04-002-01'],
    # 可以继续添加其他映射关系
}

# 振动传感器映射
VIBRATION_SENSOR_MAP = {
    "拉索加速度传感器": {
        "北索塔边跨": {
            "最远端柔性索": {
                "面内 上游": "ST-VIC-C34-101-01",
                "面外 上游": "ST-VIC-C34-101-02",
                "面内 下游": "ST-VIC-C34-102-01",
                "面外 下游": "ST-VIC-C34-102-02"
            },
            "1/4跨柔性索": {
                "面内 上游": "ST-VIC-C18-101-01",
                "面外 上游": "ST-VIC-C18-101-02",
                "面内 下游": "ST-VIC-C18-102-01",
                "面外 下游": "ST-VIC-C18-102-02"
            }
        },
        "北索塔跨中": {
            "最远端柔性索": {
                "面内 上游": "ST-VIC-C34-201-01",
                "面外 上游": "ST-VIC-C34-201-02",
                "面内 下游": "ST-VIC-C34-202-01",
                "面外 下游": "ST-VIC-C34-202-02"
            },
            "1/4跨柔性索": {
                "面内 上游": "ST-VIC-C18-201-01",
                "面外 上游": "ST-VIC-C18-201-02",
                "面内 下游": "ST-VIC-C18-202-01",
                "面外 下游": "ST-VIC-C18-202-02"
            }
        },
        "南索塔边跨": {
            "最远端柔性索": {
                "面内 上游": "ST-VIC-C34-301-01",
                "面外 上游": "ST-VIC-C34-301-02",
                "面内 下游": "ST-VIC-C34-302-01",
                "面外 下游": "ST-VIC-C34-302-02"
            },
            "1/4跨柔性索": {
                "面内 上游": "ST-VIC-C18-301-01",
                "面外 上游": "ST-VIC-C18-301-02",
                "面内 下游": "ST-VIC-C18-302-01",
                "面外 下游": "ST-VIC-C18-302-02"
            }
        },
        "南索塔跨中": {
            "最远端柔性索": {
                "面内 上游": "ST-VIC-C34-401-01",
                "面外 上游": "ST-VIC-C34-401-02",
                "面内 下游": "ST-VIC-C34-402-01",
                "面外 下游": "ST-VIC-C34-402-02"
            },
            "1/4跨柔性索": {
                "面内 上游": "ST-VIC-C18-401-01",
                "面外 上游": "ST-VIC-C18-401-02",
                "面内 下游": "ST-VIC-C18-402-01",
                "面外 下游": "ST-VIC-C18-402-02"
            }
        }
    },
    "风速风向风攻角传感器": {
        "跨中桥面上游风": "ST-UAN-G04-001-01",
        "北索塔塔顶风": "ST-UAN-T01-003-01"
    },
    # 补充CSV中的重要备注（方便查阅）
    "备注": {
        "C18数据说明": "C18的数据都是指1/4跨的数据",
        "NA含义": "NA是指北外侧（边跨）",
        "NJ含义": "NJ 是指北内侧（跨中）",
        "拉索数量": "南北两塔每塔跨中和边跨都是34根拉索"
    }
}

# 默认风传感器列表（当振动传感器没有明确映射时使用）
DEFAULT_WIND_SENSORS = [
...
# 风向修正值（针对不同传感器）
WIND_DIR_CORRECTION = {
    'ST-UAN-G04-001-01': 360,
    'ST-UAN-G04-002-01': 360,
    'ST-UAN-G02-002-01': 360,
    'ST-UAN-G02-002-02': 360,
    'ST-UAN-T01-003-01': 180,  # 塔顶传感器可能需要不同的修正值
    'ST-UAN-T02-003-01': 180,
}
...
# 风速统计时间窗口（秒）
WIND_TIME_WINDOW = 60.0

# 风速数据有效阈值（m/s，低于此值认为无效）
WIND_VALID_THRESHOLD = 0.1

# 紊流度物理上限（%，超过此值认为异常）
MAX_TURBULENCE_INTENSITY = 35.0
