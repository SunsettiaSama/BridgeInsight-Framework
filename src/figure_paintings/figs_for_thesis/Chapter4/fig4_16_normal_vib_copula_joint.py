"""
图4-16：随机振动椭圆 Copula Spearman 相关热图。

依赖：
  python -m src.chapter4_characteristics copula joint --class-id 0
"""
...
def main() -> None:
    ...
    print(f"{FIG_TAG}：绘制随机振动 Spearman 相关热图...")
