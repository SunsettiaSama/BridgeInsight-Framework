"""
图4-36：RWIV Copula 边缘概率密度（面内+面外，前 24 阶主频/能量）。

依赖：
  python -m src.chapter4_characteristics copula extract --class-id 2
  python -m src.chapter4_characteristics copula marginals --class-id 2
"""
