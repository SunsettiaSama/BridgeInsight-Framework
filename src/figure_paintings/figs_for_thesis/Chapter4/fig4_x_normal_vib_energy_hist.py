...
def plot_dominant_energy_histogram(data: dict) -> plt.Figure:
    ...
    ax.set_title('随机振动主频能量占比分布', fontproperties=CN_FONT, fontsize=FONT_SIZE, pad=14)
...
def main():
    print("=" * 80)
    print("第三章 图3.8 随机振动主频能量占比分布直方图")
    print("=" * 80)
    ...
    web_push(fig, page="fig3_13 能量占比直方图", slot=0, title="随机振动主频能量占比", page_cols=1)
    print("✓ 已推送到 WebUI")
