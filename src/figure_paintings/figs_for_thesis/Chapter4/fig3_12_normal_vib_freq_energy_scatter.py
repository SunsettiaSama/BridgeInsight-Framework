...
def plot_freq_energy_scatter(data: dict) -> plt.Figure:
    ...
    ax.set_title('随机振动主频与能量占比散点图', fontproperties=CN_FONT, fontsize=FONT_SIZE, pad=14)
...
def main():
    ...
    web_push(fig, page="fig3_12 主频-能量散点", slot=0, title="随机振动主频-能量散点", page_cols=1)
    print("✓ 已推送到 WebUI")
