"""
图4-28：VIV 椭圆 Copula Spearman 相关热图。

依赖：
  python -m src.chapter4_characteristics copula joint --class-id 1
"""
...
def main() -> None:
    ...
    print(f"{FIG_TAG}：绘制 VIV Spearman 相关热图...")
