...
class Config:
    ...
    TRIM_START_SECOND = 0
    TRIM_END_SECOND = 5        # 仅展示前10s

    NUM_SAMPLES_TO_PLOT = 2    # 每个方向最多绘制的样本数
...
def plot_normal_vib_timeseries(samples: list, unpacker: UNPACK):
    inplane_figs = []
    outplane_figs = []
...
def main():
    ...
    inplane_figs, outplane_figs = plot_normal_vib_timeseries(samples, unpacker)
